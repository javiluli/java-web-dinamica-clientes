...
public class Fecha {
   ...
   *                "yyyy/MM/dd" "dd/MM/yyyy" "dd/MM/yyyy" "yyyy-MM-dd" .... ect.
   *                Ó con tiempos "dd/MM/yyyy/hh/mm/ss" ... ect
  ...
  /**
   * 
   * Convierte un String de fecha con una mascara ,a Timestamp (fecha con
   * milisegundos)
   * 
   * @param fecha
   * @param mascara
   ...
   * @param mascara String constante separadores validos cualquier combinacion de
   *                /,-,: blancos
   * 
   * @return
   */
