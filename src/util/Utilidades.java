...
public class Utilidades {
  ...
  public static boolean esPrimo(int numero) {
    ...
    if (numero >= 0) {
      /*
       * int i=2;//todos los numeros son divisibles por 1 while( i< numero && seguir){
       * if (numero%i==0){// divisible por i ya no es primo primo=false; seguir=false;
       * } i++; }
       */
      // con un for
  ...
  public static void main(String[] args) {
    ...
    System.out.println(randomEntero(0, 2));
    /*
     * int i=1; while(i<5){ System.out.println(randomDouble(6,i)); i++; }
     */
