...
public class Validator {
  ...
  /**
   * Metodo que comprueba la cantidad de cdigitos de un numero Int.
   ...
   */
  public static int lengthInteger(int numero) {
    int digitos = 0;

    for (int x = 0; x < 10; x++) { // max 10 digitos por numero
  ...
  public static void main(String[] a) {
    ...
    System.out.println(Validator.lengthDecimal(-229.01, 5, 2));
    double a1 = 0;
