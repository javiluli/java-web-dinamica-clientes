...
// servidor es el nodo de red donde está la base de datos,se puede poner Localhost
...
objconexion=DriverManager.getConnection("jdbc:mysql://servidor/cr7",
                                        "angel","numancia");//ojo MAYUSCULAS y Minusculas
